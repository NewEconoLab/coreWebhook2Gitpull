...
namespace coreWebhook2Gitpull.Controllers
{
    ...
    public class GitHubController : Controller
    {
        ...
        public JsonResult Post([FromBody] JObject J)
        {
            ...
            System.IO.File.WriteAllText(System.IO.Directory.GetCurrentDirectory() + "/log/" + System.DateTime.Now.ToString ("yyyyMMddHHmmssms") + ".log",resStr);
